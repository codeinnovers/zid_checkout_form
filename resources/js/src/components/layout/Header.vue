                    ...
                    <div class="dropdown shrink-0">
                        <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start'" offsetDistance="8" class="!block">
                            <button type="button" class="relative group block">
                                <div class="w-9 h-9 rounded-full bg-primary flex items-center justify-center text-white text-sm font-bold saturate-50 group-hover:saturate-100 transition">
                                    {{ userInitials }}
                                </div>
                            </button>
                            <template #content="{ close }">
                                <ul class="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div class="flex items-center px-4 py-4">
                                            <div class="flex-none">
                                                <div class="rounded-md w-10 h-10 bg-primary flex items-center justify-center text-white font-bold">
                                                    {{ userInitials }}
                                                </div>
                                            </div>
                                            <div class="ltr:pl-4 rtl:pr-4 truncate">
                                                ...
                                                <span class="text-black/60 dark:text-dark-light/60 text-sm truncate block">
                                                    {{ authUser?.email ?? '' }}
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <li class="border-t border-white-light dark:border-white-light/10">
                                        <Link href="/logout" method="post" as="button" class="text-danger !py-3 w-full" @click="close()">
                                            <svg
            ...
            >
                ...
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <Link href="/pages/contact-us" target="_blank">{{ $t('contact_form') }}</Link>
                        </li>
                        <li>
                            <Link href="/pages/faq">FAQ</Link>
                        </li>
                        <li>
                            <Link href="/pages/coming-soon" target="_blank">{{ $t('coming_soon') }}</Link>
                        </li>
                        <li>
...
<script lang="ts" setup>
    ...
    const page = usePage();
    const authUser = computed(() => (page.props as any).auth?.user as { id: number; name: string; email: string } | null);
