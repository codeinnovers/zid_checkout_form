<template>
    ...
    <div class="relative text-black dark:text-white-dark min-h-screen" :class="[store.navbar, store.menu, { 'toggle-sidebar': store.sidebar }]">
