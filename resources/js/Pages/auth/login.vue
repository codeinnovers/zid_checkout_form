                ...
                <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <form class="space-y-5 dark:text-white" @submit.prevent="submit">
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="Email" type="email" v-model="form.email" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark" :class="{ 'border-red-500': form.errors.email }" />
                                ...
                                <p v-if="form.errors.email" class="text-danger mt-1">{{ form.errors.email }}</p>
                            </div>
                            <div>
                                <label for="Password">Password</label>
                                <div class="relative text-white-dark">
                                    <input id="Password" type="password" v-model="form.password" placeholder="Enter Password" class="form-input ps-10 placeholder:text-white-dark" :class="{ 'border-red-500': form.errors.password }" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path
                                                opacity="0.5"
                                            ...
                                            />
                                            <path
                                                d="M9 12.75C9.41421 12.75 9.75 12.4142 9.75 11.5858 9.41421 11.25 9 11.25C8.58579 11.25 8.25 11.5858 8.25 12C8.25 12.4142 8.58579 12.75 9 12.75Z"
                                                fill="currentColor"
                                            />
                                            <path
                                ...
                                <p v-if="form.errors.password" class="text-danger mt-1">{{ form.errors.password }}</p>
                            </div>
                            <div>
                                <label class="flex cursor-pointer items-center">
                                    <input type="checkbox" v-model="form.remember" class="form-checkbox bg-white dark:bg-black" />
                                    <span class="text-white-dark">Remember me</span>
                                </label>
                            </div>
                            <button type="submit" class="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]" :disabled="form.processing">
                        ...
                        <div class="text-center dark:text-white">
                            ...
                            <Link href="/auth/cover-register" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">
                                SIGN UP
                            </Link>
                        </div>
                    </div>
                    <p class="absolute bottom-6 w-full text-center dark:text-white">© {{ new Date().getFullYear() }}.All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
